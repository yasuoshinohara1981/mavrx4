/**
 * Scene10: 街の3Dモデル表示（Project PLATEAU）
 */
...
import { Scene10_CircleEffect } from './Scene10_CircleEffect.js';
...
export class Scene10 extends SceneTemplate {
        ...
        for (const folder of lod2Folders) {
            ...
            try {
                ...
                if (isNaN(center.x) || isNaN(center.y) || isNaN(center.z)) {
                    console.warn(`[Scene10] Warning: NaN detected in building center calculation.`);
                    continue;
                }
    ...
    async loadDEM() {
        ...
        for (const id of demIds) {
            ...
            try {
                ...
                if (isNaN(center.x) || isNaN(center.y) || isNaN(center.z)) {
                    console.warn(`[Scene10] Warning: NaN detected in DEM center calculation.`);
                    continue;
                }
    ...
    triggerCircleEffect(velocity, durationMs) {
        ...
        const effect = new Scene10_CircleEffect(center, velocity, durationMs);
