/**
 * Scene06_BuildingSystem: CPU版でビルを管理
 * 各ビルを個別のMeshとして描画（Processing版と同じ）
 */

import * as THREE from 'three';
import { Scene06_Building } from './Scene06_Building.js';

export class Scene06_BuildingSystem {
    ...
    initializeBuildings() {
        ...
        for (let i = 0; i < this.numLandmarkBuildings; i++) {
            ...
            const building = new Scene06_Building(pos, widthX, widthZ, height, true);
        ...
        for (let i = 0; i < this.numBuildings; i++) {
            ...
            const building = new Scene06_Building(pos, widthX, widthZ, height, false);
            this.buildings.push(building);
